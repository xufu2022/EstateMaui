...
namespace RealEstateApi.Data
{
    public class ApiDbContext : DbContext
    {
        ...
        {
          optionsBuilder.UseSqlServer(@"Server=tcp:futest.database.windows.net,1433;Initial Catalog=RealEstateDb;Persist Security Info=False;User ID=fu;Password=<yourpassword>;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        }
